package com.github.lucky.clash.core

import com.github.lucky.clash.core.bridge.*
import com.github.lucky.clash.core.model.*
import com.github.lucky.clash.core.util.parseInetSocketAddress
...
object Clash {
    ...
    fun queryConnections(): List<ConnectionTraffic> {
        val connections = Json.Default.decodeFromString(
            JsonArray.serializer(),
            Bridge.nativeQueryConnections()
        )

        return connections.map {
            Json.Default.decodeFromJsonElement(ConnectionTraffic.serializer(), it)
        }
    }
