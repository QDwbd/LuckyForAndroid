...
import com.github.lucky.clash.common.compat.getColorCompat
import com.github.lucky.clash.common.compat.pendingIntentFlags
import com.github.lucky.clash.common.compat.startForegroundCompat
...
import com.github.lucky.clash.log.LogcatCache
import com.github.lucky.clash.log.LogcatWriter
import com.github.lucky.clash.service.RemoteService
import com.github.lucky.clash.service.remote.ILogObserver
import com.github.lucky.clash.service.remote.IRemoteService
import com.github.lucky.clash.service.remote.unwrap
...
class LogcatService : Service(), CoroutineScope by CoroutineScope(Dispatchers.Default), IInterface {
    ...
    private fun createNotificationChannel() {
        NotificationManagerCompat.from(this)
            .createNotificationChannel(
                ...
                ).setName(getString(com.github.lucky.clash.design.R.string.clash_logcat)).build()
            )
    }
    ...
    private fun showNotification() {
        val notification = NotificationCompat
            ...
            .setSmallIcon(com.github.lucky.clash.service.R.drawable.ic_logo_service)
            .setColor(getColorCompat(com.github.lucky.clash.design.R.color.color_clash_light))
            .setContentTitle(getString(com.github.lucky.clash.design.R.string.clash_logcat))
            .setContentText(getString(com.github.lucky.clash.design.R.string.running))
            .setContentIntent(
