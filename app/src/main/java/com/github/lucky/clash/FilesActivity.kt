...
import com.github.lucky.clash.common.util.grantPermissions
...
import com.github.lucky.clash.design.FilesDesign
import com.github.lucky.clash.design.util.showExceptionToast
import com.github.lucky.clash.remote.FilesClient
import com.github.lucky.clash.service.model.Profile
import com.github.lucky.clash.util.fileName
                    ...
                    try {
                        when (it) {
                            ...
                            is FilesDesign.Request.OpenFile -> {
                                val uri = client.buildDocumentUri(it.file.id)

                                val external = Intent(Intent.ACTION_VIEW)
                                ...
                                if (external.resolveActivity(packageManager) != null) {
                                    ...
                                    startActivity(FileViewerActivity::class.intent.setData(uri))
                                }
                            }
